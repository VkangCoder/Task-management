...
const { TaskStatusRoutes } = require("./api/v1/routes/task_status_route");
const { CommentRoutes } = require("./api/v1/routes/comment_route");
...
app.use("/v1/taskStatus", TaskStatusRoutes);
